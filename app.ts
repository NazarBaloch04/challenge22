...
function twoNumbersDivision(num1: number, num2: number): number {
...
function checkBothValuesTrue(val1: boolean, val2: boolean): boolean {
...
// This function sees if both inputs are true
function checkBothValuesFalse(val1: boolean, val2: boolean): boolean {
    // Only says true if both val1 and val2 are true
    return val1 && val2;
}
